...
const login = async (data)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post("/login", data);
...
const useAuth = ()=>{
        ...
        "useAuth.useEffect": ()=>{
            const loadUser = {
                "useAuth.useEffect.loadUser": ()=>{
                    const currentUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUser"])();
                    setUser(currentUser);
                    setLoading(false);
                }
            }["useAuth.useEffect.loadUser"];
    ...
    const handleLogin = async (data)=>{
        setError(null);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(data);
            setUser({
                username: data.username
            });
    ...
    return {
        ...
        login: handleLogin,
        logout: handleLogout,
        isAuthenticated: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAuthenticated"])()
    };
};
...
const AuthProvider = ({ children })=>{
    _s();
    const auth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
//# sourceMappingURL=app_4da746c8._.js.map