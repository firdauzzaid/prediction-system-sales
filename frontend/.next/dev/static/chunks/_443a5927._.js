...
const useAuth = ()=>{
                ...
                "useAuth.useEffect.initAuth": async ()=>{
                    try {
                        ...
                        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAuthenticated"])()) {
                            ...
                            const isValid = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["verifyToken"])();
                            if (isValid) {
                                setUser((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUser"])());
                            } else {
    ...
    const handleLogin = async (data)=>{
        setError(null);
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(data);
            setUser({
                username: data.username
            });
...
//# sourceMappingURL=_443a5927._.js.map